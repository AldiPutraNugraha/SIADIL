...
export default function FacilitiesMaintenancePage() {
  ...
  const rows = generateDocs(25, 'Facilities & Maintenance');
  return (
      ...
      <div className="bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Facilities & Maintenance</h1>
              <nav className="flex items-center space-x-2 text-sm mt-2">
                ...
                <span className="text-gray-800">Facilities & Maintenance</span>
              </nav>
            </div>
